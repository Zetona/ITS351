		...
		<div id="div_content" class="usergroup">
			...
			isset($_POST['url'])
				...
				if (isset($_POST['page']) && $_POST['edit'] == 1 )  {
					...
					" USERGROUP_CODE = '".$_POST['groupcode']."',".
					" USERGROUP_NAME = '".$_POST['groupname']."',".
					" USERGROUP_REMARK = '".$_POST['remark']."',".
					" USERGROUP_URL = '".$_POST['url']."'".
					" where USERGROUP_ID = ".$_POST['groupid']." ";
			...
			<table>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><a href='add_group.php?id=<?php echo $row['USERGROUP_ID']?>'> <img src="images/Modify.png" width="24" height="24"></a></td>
